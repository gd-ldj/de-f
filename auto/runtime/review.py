"""Task review wrapper for AUTO v2."""
...
def run_review(
    ...
    *,
    ...
    payload = {
        ...
        "context_paths": _filter_review_context_paths(
    ...
    task_dir_path.joinpath("REVIEW.json").write_text(json.dumps(result, indent=2) + "\n", encoding="utf-8")
    return result


def _filter_review_context_paths(paths: dict[str, str]) -> dict[str, str]:
    allowed = ("requirement", "spec", "tasks", "qa_units", "result", "review", "status")
