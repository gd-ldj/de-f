        ...
        {researchArticles.map((article, index) => (
          <article key={article.entry_id} className="flex space-x-3 bg-white md:border border-gray-100 rounded py-3 hover:shadow-md transition-shadow">
            ...
            <div className="flex-1 space-y-2">
              ...
              {/* Article description */}
              <p className="hidden md:block md:text-muted-foreground md:text-xs md:line-clamp-4 md:leading-relaxed">{t('research.tradingBotsDescription')}</p>
          ...
          <article key={article.entry_id} className="rounded overflow-hidden group bg-white border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <div className="p-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm mb-4 line-clamp-4 leading-relaxed">{t('research.tradingBotsDescription')}</p>
