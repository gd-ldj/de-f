  ...
  return (
    <div className="bg-white rounded border border-border p-6">
      ...
      <div className="space-y-4">
        {hunters.map((hunter) => (
          <div key={hunter.id} className="flex items-center justify-between py-2 border-b border-border last:border-b-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="text-base font-medium text-foreground">{hunter.username}</span>
                <span className="text-sm text-muted-foreground">{hunter.timeAgo}</span>
              </div>
            </div>

            {/* Right side - Reward amount */}
            <div className="flex items-center space-x-2 bg-secondary border border-border rounded px-3 py-2">
