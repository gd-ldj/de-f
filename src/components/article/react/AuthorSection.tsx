      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-shrink-0">
            <img src={author.avatar || '/placeholder.svg'} alt={author.name} className="w-12 h-12 rounded-full object-cover" />
          </div>

          {/* Author Details */}
          <div className="flex-1">
            {/* Author Name */}
            <h4 className="text-lg font-medium text-teal-600 mb-1">{author.name}</h4>
        ...
        <div className="flex items-center space-x-3 ml-4">
          {/* X (Twitter) Button */}
          {author.twitter && (
            <button onClick={handleXClick} className="w-8 h-8 flex items-center justify-center bg-white border border-gray-300 rounded hover:bg-gray-50 transition-colors" aria-label="Follow on X">
          ...
          {/* Email Button */}
          {author.email && (
            <button onClick={handleEmailClick} className="w-8 h-8 flex items-center justify-center bg-white border border-gray-300 rounded hover:bg-gray-50 transition-colors" aria-label="Send email">
          ...
          {/* Subscribe Button */}
          <button onClick={handleSubscribeClick} className="px-4 py-2 bg-teal-600 text-white text-sm font-medium rounded hover:bg-teal-700 transition-colors">
