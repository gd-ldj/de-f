...
const MobileHeader: React.FC<MobileHeaderProps> = ({ locale: propLocale, onLocaleSwitch, currentPath }) => {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <MobileSidebar isOpen={mobileSidebarOpen} onClose={handleMobileSidebarClose} locale={locale} onLocaleSwitch={handleLocaleSwitch} onCategoryPageOpen={handleMobileCategoryPageOpen} />
